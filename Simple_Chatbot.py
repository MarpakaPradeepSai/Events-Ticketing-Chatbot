...
# Streamlit app title
st.title("Customer Support Chatbot for Events Ticketing")
...
def load_spacy_model():
    try:
        ...
        # If en_core_web_trf is not installed, download it
...
user_question = st.text_input("Ask your question about events ticketing:", "")
...
if user_question:
    ...
    st.markdown(response, unsafe_allow_html=True) # Use markdown to render bold tags as HTML


st.sidebar.header("About")
st.sidebar.info(
    "This is a simple Customer Support Chatbot for Events Ticketing. "
    "It uses a fine-tuned ALBERT model to understand user intents and provide relevant responses."
)
